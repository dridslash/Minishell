...
/*   Updated: 2022/04/11 14:51:44 by mnaqqad          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	pwd_built_in_separ(t_cmd *holder_nodes, t_env **env_var, int *pipes)
{
	...
	t_env **env_var, int *pipes)
{
	...
	else if (ft_strcmp(which_built_in(holder_nodes), "export") == 0)
	{
		...
		pwd_built_in_separ(holder_nodes, env_var, pipes);
	...
	t_env **env_var, int *pipes)
{
	...
	{
		separ_help_built_in_red_one(holder_nodes, env_var, pipes);
	}
