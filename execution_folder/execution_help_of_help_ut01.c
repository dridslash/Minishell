...
/*   Updated: 2022/04/11 10:07:49 by mnaqqad          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_env **env_var, int *pipes)
{
	if (ft_strcmp(which_built_in(holder_nodes), "cd") == 0)
		return (ft_cd_separ_built_in_red_two(holder_nodes, env_var, pipes));
	else if (ft_strcmp(which_built_in(holder_nodes), "export") == 0)
	{
		...
		return (pwd_separ_built_in_red_two(holder_nodes, env_var, pipes));
	...
	else if (ft_strcmp(which_built_in(holder_nodes), "env") == 0)
	{
		...
		return (ft_echo_separ_buint_in_red_two(holder_nodes, env_var, pipes));
	return (0);
}
