...
/*   Updated: 2022/04/10 17:12:21 by mnaqqad          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void  func_built_ins_send_redi(t_cmd *holder_nodes, int *pipes, int iterate_for_fds, t_env **env_var)
{
...
void func_built_ins_send_redi_two(t_cmd *holder_nodes, int *pipes, int iterate_for_fds, t_env **env_var)
{
	if (is_there_a_built_in(holder_nodes))
		{
				if (ft_strcmp(which_built_in(holder_nodes),"cd") == 0)
...
void func_built_ins_send_redi_three(t_cmd *holder_nodes, int *pipes, int iterate_for_fds, t_env **env_var)
{
	if (is_there_a_built_in(holder_nodes))
		{
				if (ft_strcmp(which_built_in(holder_nodes),"cd") == 0)
